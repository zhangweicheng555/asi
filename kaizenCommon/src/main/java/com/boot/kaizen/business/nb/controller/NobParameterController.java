 ...
 */
@Controller
@RequestMapping("/nb/parameter")
public class NobParameterController {
	...
	public TableResultUtil find(RequestParamEntity param) {
		...
		PageInfo<NobParamcheck> pageInfo = PageHelper.startPage(param.getPage(), param.getLimit())
				.doSelectPageInfo(new ISelect() {
					@Override
					public void doSelect() {
						nobParameterService.query(param.getMap());
					}
				});
	...
	public JsonMsgUtil edit(NobParamcheck nobParamcheck) {
		LoginUser loginUser = UserUtil.getLoginUser();
		return nobParameterService.edit(nobParamcheck, loginUser);
	}
	...
	public JsonMsgUtil findById(@RequestParam("id") String id) {
		return nobParameterService.findById(id);
	}
	...
	public JsonMsgUtil delete(@RequestParam("ids") String ids) {
		return nobParameterService.delete(ids);
	}
