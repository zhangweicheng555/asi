...
public enum CompanyRoleType {
	...
	WANG_YOU_GUANLI_CHU("WANG_YOU_GUANLI_CHU", "网优管理处")//  发布任务  【这个角色就可以】
	
	, CHANG_JIA_DANYAN_LEADER("CHANG_JIA_DANYAN_LEADER", "厂家单验负责人")//  厂家任务确认  厂家审核
	, CHANG_JIA_DANYAN_REGION_LEADER("CHANG_JIA_DANYAN_REGION_LEADER", "厂家单验区域负责人")// 区域任务分配  厂家区域审核    
	, CHECK_ENGINEER("CHECK_ENGINEER", "塔工")//   勘站里面的   现场勘站   以上三个   【角色+厂家+分公司】

	, WANG_YOU_FEN_QU("WANG_YOU_FEN_QU", "网优分区")//   报告审核      【角色+分区】
